...
while (keep_processing):
    ...
    show_images(undistortedL,undistortedR)
    # start the event loop - essential
...
np.savetxt("_RL.txt",RL)
np.savetxt("_PL.txt",RL)
np.savetxt("_RR.txt",RR)
np.savetxt("_PR.txt",PR)
...
np.savetxt("_camera_matrix_l.txt",camera_matrix_l)
np.savetxt("_camera_matrix_r.txt",camera_matrix_r)

np.savetxt("_dist_coeffs_l.txt",dist_coeffs_l)
np.savetxt("_dist_coeffs_r.txt",dist_coeffs_r)
...
np.savetxt("_mapL1.txt",mapL1)
np.savetxt("_mapL2.txt",mapL2)

np.savetxt("_mapR1.txt",mapR1)
np.savetxt("_mapR2.txt",mapR2)
